                    ...
                    <div class="header-bottom-right">
                                            ...
                                            if ($categoryResult->num_rows >= 1) {
                                                ...
                                                foreach ($categories as $category) { ?>
                                                    ...
                                                    <li>
                                                        <ul>
                                                            <li class="nav-link">
                                                                <a class="h3 font-weight-bold" href="shop.php?category=<?= $category['id'] ?>"><?= $category['name_en'] ?></a>
                                                            </li>
                                                            <?php
                        ...
                        if (empty($_SESSION['user'])) { ?>
                            ...
                            <div class="header-currency">
                                <span class="digit">Signin/Signup <i class="ti-angle-down"></i></span>
                        ...
                        <?php } else { ?>
                            <div class="header-currency">
                                <span class="digit"><?= ucfirst($_SESSION['user']->first_name) . " " . ucfirst($_SESSION['user']->last_name)   ?><i class="ti-angle-down"></i></span>
                                <div class="dollar-submenu">
                                    <ul>
