...
{
    private $id, $first_name, $last_name, $phone, $email, $password, $gender, $image,
        $remember_token, $verification_code, $forget_code, $status,
        $email_verified_at, $code_expiration, $created_at, $updated_at;
    ...
    {
        $query = "INSERT INTO `users` (`first_name`,`last_name`,`email`,`phone`,`password`,`verification_code`,`gender`)
        VALUES ('{$this->first_name}','{$this->last_name}','{$this->email}','{$this->phone}','{$this->password}','{$this->verification_code}','{$this->gender}')";
