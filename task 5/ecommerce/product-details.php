...
if (isset($_GET['id'])) {
    if (is_numeric($_GET['id'])) {
        ...
        $result =   $productObject->setStatus(ACTIVE)->setId($_GET['id'])->find();
                ...
                <div class="product-details-content">
                    ...
                    <div class="pro-dec-categories">
                        <ul>
                            ...
                            <li><a href="shop.php?subcategory=<?= $product->subcategory_id ?>"><?= $product->subcategories_name_en ?> </a> | </li>
            ...
            <div class="tab-content description-review-bottom">
                ...
                <div id="des-details3" class="tab-pane">
                    <div class="rattings-wrapper">
                        ...
                        $reviewResult = $productObject->getReviews()->fetch_all(MYSQLI_ASSOC);
